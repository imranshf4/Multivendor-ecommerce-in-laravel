                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="{{ route('site.setting.update') }}" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Bkash Number</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="phone_one" class="form-control" value="{{ $setting->bkash_number }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Rocket Number</h6>
                                    </div>
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" name="phone_one" class="form-control" value="{{ $setting->rocket_number }}" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage"
                                            src="{{ (!empty($setting->logo)) ? url($setting->logo):url('upload/no_image.jpg') }}"
