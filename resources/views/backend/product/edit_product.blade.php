                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select class="form-select" name="vendor_id" id="inputCollection">
                                            <option value=""></option>
                                            @foreach($activeVendor as $activeV)
                                            <option value="{{ $activeV->id  }}" {{ $activeV->id == $products->vendor_id ? 'selected' : '' }}>{{ $activeV->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
...
<div class="page-content">
    <div class="card">
        <div class="card-body p-4">
            ...
            <hr />
            <div class="form-body mt-4">
                <form id="myForm" method="post" action="{{ route('update.mainThumb.product') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $products->id }}">
                ...
                <tbody>
                    <form id="myForm" method="post" action="{{ route('update.product.MultiImage') }}" enctype="multipart/form-data">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="submit" class="btn btn-primary px-4" value="Update Image" />
                                <a class="btn btn-danger" href="{{ route('delete.product.MultiImage',$img->id) }}" id="delete">Delete</a>
                            </td>
                        </tr>
                        @endforeach
                    </form>
