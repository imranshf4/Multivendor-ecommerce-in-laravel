                    ...
                    <div class="card">
                        <div class="card-body">
                            <form id="myForm" method="post" action="{{ route('update.category') }}" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="old_image" value="{{ $categorys->category_image }}">
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">Category Name</h6>
                                    </div>
                                    <div class="form-group col-sm-9 text-secondary">
                                        <input type="text" name="category_name" value="{{ $categorys->category_name }}" class="form-control" />
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <img id="showImage"
                                            src="{{ asset( $categorys->category_image ) }}"
