@php
$featureds = App\Models\Product::where('featured',1)->orderBy('id','ASC')->limit(6)->get();
            ...
            <div class="col-lg-9 col-md-12 wow animate__animated animate__fadeIn" data-wow-delay=".4s">
                <div class="tab-content" id="myTabContent-1">
                                ...
                                <div class="product-cart-wrap">
                                    <div class="product-img-action-wrap">
                                        ...
                                        <div class="product-action-1">
                                            ...
                                            <a aria-label="Add To Wishlist" class="action-btn small hover-up" id="{{ $product->id }}" onclick="addToWishLists(this.id)"><i class="fi-rs-heart"></i></a>
                    ...
                    <div class="sold mt-15 mb-15">
                        ...
                        <span class="font-xs text-heading"> Sold: {{ $product->product_qty }}</span>
