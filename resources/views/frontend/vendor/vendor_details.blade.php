...
<div class="container mb-30">
    <div class="archive-header-2 text-center pt-80 pb-50">
        <h1 class="display-2 mb-50 text-capitalize">{{ $vendor->name }} Store</h1>
        ...
        <div class="col-lg-1-5 primary-sidebar sticky-sidebar">
            <div class="sidebar-widget widget-store-info mb-30 bg-3 border-0">
                ...
                <div class="vendor-info">
                    <div class="product-category">
                        <span class="text-heading">Since {{ $vendor->vendor_join }}</span>
                    </div>
                    <h4 class="mb-5"><a href="vendor-details-1.html" class="text-heading text-capitalize">{{ $vendor->name }}</a>
                    </h4>
                    ...
                    <div class="vendor-info">
                        <ul class="font-sm mb-20">
                            ...
                            <li><img class="mr-5" src="{{ asset('frontend/assets/imgs/theme/icons/icon-contact.svg') }}" alt="" /><strong>Call Us:</strong><span>(+880) - {{ $vendor->phone }}</span></li>
                        </ul>
